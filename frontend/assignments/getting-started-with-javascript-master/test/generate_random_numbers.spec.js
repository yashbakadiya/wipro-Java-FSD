...
describe("Check Generate Random Numbers", function () {
    ...
    it("should be a function", function () {
        ...
        expect(typeof(_generateRandomNumber)).equal("function");
    ...
    it("should return error message if the min value is greater than max value", function () {
        ...
        expect(_generateRandomNumber).equal("Incorrect Inputs. 1st value should be less than the second");   
    });
    ...
    it("should return error message for the invalid input types provided", function () {
        ...
        expect(_generateRandomNumber).equal("Invalid Input Types, All Inputs Should Be of Type Number !!");   
    });
});
